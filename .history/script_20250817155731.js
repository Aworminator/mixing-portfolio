let songs = [
  {
    ...
    song: "Tide and Timber, Sand and Cider",
  ...
  },
  {
    ...
    song: "Live From <br> Valdosta, Georgia",
    name: "Fireflies - Camino Kid.wav",
  },
];
...
songs.forEach((song) => {
  ...
  card.innerHTML = `
    ...
    <div class="mp3">
      <div class="band-info">
        <h1 class="band-name">${song.album}</h1>
        <h2 class="album-title">${song.artist}</h2>
      </div>
      <div class="player">
