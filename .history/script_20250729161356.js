...
function toggleAudio(songName) {
  ...
  const bandName = document.querySelector(`#audio-${songName}`).closest('.player').parentElement.querySelector('.band-name');
  const albumTitle = document.querySelector(`#audio-${songName}`).closest('.player').parentElement.querySelector('.album-title');
