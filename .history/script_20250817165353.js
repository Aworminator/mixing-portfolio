let songs = [
  {
    ...
    artistLink: "https://open.spotify.com/artist/7cl9j0U54gBxbcGO7zXXs2?si=Y8YFn_WdRy2WaXkD7kTK9A",
    songLink: "https://open.spotify.com/track/4LscxvJWC9iHOBJmns7oVh?si=cf5a5d8cefe242de"
  },
  {
    albumArt:
    ...
    artistLink: "https://open.spotify.com/artist/3Mm4P393IFVqIQDmL691G9?si=A1uk_0hjSPOLajqtXdFjjQ",
    songLink: "https://open.spotify.com/track/2iAruT7aaz0of7HgP6AXJ5?si=48f3d1c8590f4527",
  },
  {
    albumArt:
    ...
    artistLink: "https://open.spotify.com/artist/7LDoytlH8MNe9zu2VIu5uB?si=W9AvoN22T46V6yPUWuvBdA",
    songLink: "https://open.spotify.com/track/77lonoP2aKYjy99jGNJf3r?si=8c8acfcdc6ff47a3",
  },
  {
    albumArt:
    ...
    song: "All Is Well",
    name: "All Is Well - Jared Withrow.wav",
    artistLink: "https://open.spotify.com/artist/5HWM1z6NnHcvOnUeLcCAKn?si=47omOcpARfSCEVpzm1sS9w",
    songLink: "https://open.spotify.com/track/60aH38LMrZZam1xIewtDBR?si=670e49b3f44149bb",
  },
  {
    albumArt:
    ...
    name: "Fireflies - Camino Kid.wav",
    artistLink: "https://open.spotify.com/artist/5Dm6l5ypjnBRX4r3o2vzkZ?si=yQY43V2TQ06EWhuZaBigIg",
    songLink: "https://open.spotify.com/track/2ckxbqWp45dph2w9lZHEuz?si=ac1ee9025897455e",
  },
  {
    albumArt:
    ...
    name: "Fireflies - Camino Kid.wav",
    artistLink: "https://open.spotify.com/artist/1zxZJBr1JIL8X4zDvpkFos?si=ZAqeO_ZFRFWOyXo424s7Ng",
    songLink: "https://open.spotify.com/track/74FoVUSj3mCoDl6XZTojDW?si=b75b83345caf4865",
  },
];
...
songs.forEach((song) => {
  ...
  card.innerHTML = `
    ...
    <div class="mp3">
      <div class="band-info">
        <a href="${song.link}" class="link"><h1 class="band-name">${song.song}</h1></a>
        <a href="" class="link"><h2 class="album-title">${song.artist}</h2></a>
      </div>
      <div class="player">
